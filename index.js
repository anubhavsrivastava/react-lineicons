...
import './line-icons/LineIcons.min.css';

const LineIcon = ({ name, size, effect, style, ...rest, tag:Tag }) => <Tag className={`lni-${name} size-${size} ${effect?`lni-${effect}-effect`: '' }`} style={style} {...rest} />;
